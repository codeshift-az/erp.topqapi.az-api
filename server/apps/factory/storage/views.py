...
# Local
from server.apps.factory.storage.logic.filters import FactoryStorageItemFilter
from server.apps.factory.storage.logic.serializers import FactoryStorageItemSerializer
from server.apps.factory.storage.models import FactoryStorageItem


class FactoryStorageItemViewSet(viewsets.ModelViewSet):
    """Viewset for FactoryStorageItem model."""

    queryset = FactoryStorageItem.objects.none()
    serializer_class = FactoryStorageItemSerializer

    filterset_class = FactoryStorageItemFilter
    ordering_fields = "__all__"

    verbose_name = "item in factory storage"
    verbose_name_plural = "items in factory storage"
