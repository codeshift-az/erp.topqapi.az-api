...
# Local
from server.apps.factory.sale.logic.filters import FactorySaleFilter
from server.apps.factory.sale.logic.serializers import FactorySaleSerializer
from server.apps.factory.sale.models import FactorySale


class FactorySaleViewSet(viewsets.ModelViewSet):
    """Viewset for FactorySale model."""

    queryset = FactorySale.objects.none()
    serializer_class = FactorySaleSerializer

    filterset_class = FactorySaleFilter
    ordering_fields = "__all__"

    verbose_name = "sale in factory "
    verbose_name_plural = "sales in factory "

    lookup_field = "id"

    def get_queryset(self):
        """Get queryset for FactorySaleViewSet."""
        return FactorySale.objects.all()
