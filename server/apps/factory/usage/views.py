...
# Local
from server.apps.factory.usage.logic.filters import FactoryUsageFilter
from server.apps.factory.usage.logic.serializers import FactoryUsageSerializer
from server.apps.factory.usage.models import FactoryUsage


class FactoryUsageViewSet(viewsets.ModelViewSet):
    """Viewset for FactoryUsage model."""

    queryset = FactoryUsage.objects.none()
    serializer_class = FactoryUsageSerializer

    filterset_class = FactoryUsageFilter
    ordering_fields = "__all__"

    verbose_name = "usage in factory "
    verbose_name_plural = "usages in factory "

    lookup_field = "id"

    def get_queryset(self):
        """Get queryset for FactoryUsageViewSet."""
        return FactoryUsage.objects.all()
