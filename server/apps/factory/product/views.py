...
# Local
from server.apps.factory.product.logic.filters import FactoryProductFilter
...
class FactoryProductViewSet(viewsets.ModelViewSet):
    """Viewset for FactoryProduct model."""

    queryset = FactoryProduct.objects.none()
    serializer_class = FactoryProductSerializer

    filterset_class = FactoryProductFilter
    ordering_fields = "__all__"

    verbose_name = "product in factory"
    verbose_name_plural = "products in factory"

    lookup_field = "id"

    def get_queryset(self):
        """Get queryset for FactoryProductViewSet."""
